...
// // Profile Image and CompanyLogo components remain unchanged
...
//   // Modified handleInputChange to handle nested contact fields
//   const handleInputChange = useCallback(async (e) => {
//     const { name, value } = e.target;
...
//         setSubmitError('Website must start with http:// or https://');
//         setFormData(prev => ({
//           ...prev,
//           [name]: value
//         }));
...
//   // Separated contact info update logic
...
//     if (!contactChanged) {
//       return null; // No contact info changes
//     }
...
//     try {
//       return await ProfileService.updateContactInfo(contactData);
//     } catch (error) {
//       throw error;
//     }
//   };
...
//     try {
//       // First handle profile info update with the regular fields
//       const updateFormData = new FormData();
...
//       // Include photos/logos if there are new ones
//       if (previewFile) {
//           updateFormData.append('photo', previewFile);
//       }
...
//       // Determine if we need to update the profile or contact info or both
//       const needProfileUpdate = updateFormData.entries().next().done === false;
//       const needContactUpdate = 
//         formData.email !== originalFormData.email ||
//         formData.website !== originalFormData.website ||
//         JSON.stringify(formData.contact) !== JSON.stringify(originalFormData.contact);
...
//             photo_url: cleanImageUrl(updatedProfile.photo_url),
//             title: updatedProfile.title,
//             bio: updatedProfile.bio,
//             company_logo_url: cleanImageUrl(updatedProfile.company_logo_url)
//           };
...
//       // If we have updates, apply them to our state
...
//         // Update original form data with the new values
//         setOriginalFormData(finalUpdatedData);
...
//         setPreviewData(finalUpdatedData);
...
//           <div className="form-group">
//             <label htmlFor="contact.twitter">Twitter/X Profile</label>
//             <input
//               id="contact.twitter"
//               type="text"
...
//             {/* Contact Buttons Section - Updated with actual values */}
//             <div className="contact-buttons">
//               {previewData.email && (
//                 <div className="contact-button">
//                   <span>Email</span>
